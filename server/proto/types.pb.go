...
// An enum to represent the person's phone type
...
type Person struct {
	...
	Id    int32  `protobuf:"varint,2,opt,name=id,proto3" json:"id,omitempty"`      // Unique ID number for the person
	Email string `protobuf:"bytes,3,opt,name=email,proto3" json:"email,omitempty"` // Email address of the person
	// Repeated fields can contain 0 or more of the specified message (like an array)
...
// A nested message representing a phone number
type Person_PhoneNumber struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Number string           `protobuf:"bytes,1,opt,name=number,proto3" json:"number,omitempty"`                         // The phone number
	Type   Person_PhoneType `protobuf:"varint,2,opt,name=type,proto3,enum=main.Person_PhoneType" json:"type,omitempty"` // The type of phone
}
...
var file_proto_types_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x04, 0x6d, 0x61, 0x69, 0x6e, 0x22, 0xf4, 0x01, 0x0a, 0x06, 0x50, 0x65,
	...
	0x6d, 0x69, 0x6b, 0x65, 0x79, 0x2f, 0x67, 0x6f, 0x2d, 0x76, 0x69, 0x74, 0x65, 0x2d, 0x61, 0x70,
...
var file_proto_types_proto_goTypes = []interface{}{
	...
	(*Person_PhoneNumber)(nil), // 2: main.Person.PhoneNumber
}
var file_proto_types_proto_depIdxs = []int32{
	2, // 0: main.Person.phones:type_name -> main.Person.PhoneNumber
	0, // 1: main.Person.PhoneNumber.type:type_name -> main.Person.PhoneType
